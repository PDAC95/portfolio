...
const Contact = () => {
  ...
  const onSubmit = (e) => {
    ...
    if (name.length === 0 || email.length === 0 || message.length === 0) {
      ...
      emailjs
        .send(
          "service_v3rbh9z", // service id
          "template_vk3l2il", // template id
          mailData,
          "P6fzQbaPaZYF8QecP" // public api
        )
        .then(
          (response) => {
            setError(false);
      ...
      <div className="row">
        <div className="col-lg-12 m-30px-b sm-m-15px-b">
          <div className="contact-form">
            <h4 className="dark-color font-alt m-20px-b">Let’s Connect</h4>
      ...
      <div className="row">
        <div className="col-md-4 m-15px-tb">
          <div className="contact-info">
            ...
            <h6 className="dark-color font-alt">Location</h6>
            <p>Kitchener, On. N2H 2Y5</p>
          </div>
        </div>
        <div className="col-md-4 m-15px-tb">
          <div className="contact-info">
            <i className="theme-color ti-mobile" />
            <h6 className="dark-color font-alt">Call Me</h6>
            <p>
              Phone: 226-341-99-61
            </p>
          </div>
        ...
        <div className="col-md-4 m-15px-tb sm-m-0px-b">
          <div className="contact-info">
            ...
            <h6 className="dark-color font-alt">Let’s Connect by Email</h6>
            <p>
              patricio@ac95.ca
            </p>
          </div>
